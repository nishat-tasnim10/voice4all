...
function HelpCenter() {
  ...
  const topics = [
    ...
    },
    {
      ...
      description:
        "Get help from the Voice4All support team.",
    },
  ];
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer:
        "Open the My Complaints page to view the status and details of your complaint.",
    },
    {
      question:
    ...
    },
    {
      ...
      answer:
        "Use the Contact Support button to get assistance from the Voice4All support team.",
    },
  ];
  ...
  return (
    <div className="help-center">
      ...
      <section className="help-hero">
        ...
        <p>
          Find answers and support for Voice4All.
        </p>
